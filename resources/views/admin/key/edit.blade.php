                ...
                <div class="app-main" id="main">
                    ...
                    <div class="container-fluid">
                            ...
                            <div class="col-md-12 m-b-30">
                                ...
                                <div class="d-block d-sm-flex flex-nowrap align-items-center">
                                    <div class="page-title mb-2 mb-sm-0">
                                        <h1 class="text-primary text-capitalize"><a href="{{route('admin.dashboard.keys.index')}}">Keys</a> / <span class="text-secondary">Edit</span></h1>
                                    </div>
                       ...
                       @endif
                        ...
                        <form action="{{route('admin.dashboard.keys.update',$key->id)}}" method="post" style="max-width: 800px">
                            @csrf   
                            @method('PUT')
                            <div class="form-group row align-items-center">
                                <label for="key" class="col-md-4 text-capitalize font-weight-bold">Key</label>
                                <div class="col-md-8">
                                    <input type="text" name="key" value="{{$key->password}}" placeholder="Set a key" id="key" class="form-control">
                                </div>
                            </div>
                            <input type="submit" value="Update Key" class="btn btn-primary">
                        </form>
                    </div>
                    <!-- end container-fluid -->
                </div>
