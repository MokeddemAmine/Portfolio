                        ...
                        <div class="col-md-12 m-b-30">
                            ...
                            <div class="d-block d-lg-flex flex-nowrap align-items-center">
                                <div class="page-title mr-4 pr-4 border-right">
                                    <h1>Main / <a href="{{route('admin.dashboard.main.portfolio.index')}}">Project</a> / <span class="text-secondary"> {{$project->title}} (edit)</span></h1>
                                </div>
                            ...
                            <div class="page-content my-4">
                                <div class="container">
                                    <form action="{{route('admin.dashboard.main.portfolio.project.update',$project->id)}}" style="max-width: 800px" method="POST" enctype="multipart/form-data">
                                        @csrf
                                        @method('PUT')
