                        ...
                        <div class="col-md-12 m-b-30">
                            ...
                            <div class="d-block d-lg-flex flex-nowrap align-items-center">
                                <div class="page-title mr-4 pr-4 border-right">
                                    <h1>Main / <span class="text-secondary">Resume</span></h1>
                                </div>
                            ...
                            <div class="page-content my-4">
                                <div class="container">
                                    ...
                                    @endif
                                    <a href="{{route('admin.dashboard.main.resume.create')}}" class="btn btn-info btn-sm my-3 text-capitalize">add resume</a>
                                </div>
                            </div>
                        </div>
                    </div>
