                        ...
                        <div class="col-md-12 m-b-30">
                            ...
                            <div class="d-block d-lg-flex flex-nowrap align-items-center">
                                <div class="page-title mr-4 pr-4 border-right">
                                    <h1>Main / <a href="{{route('admin.dashboard.main.resume.index')}}">Resume</a> / <a href="{{route('admin.dashboard.main.resume.show',$resume->id)}}" class="text-capitalize">{{$resume->name}}</a> / <span class="text-secondary text-capitalize">create</span> </h1>
                                </div>
