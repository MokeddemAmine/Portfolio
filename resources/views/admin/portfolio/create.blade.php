                        ...
                        <div class="col-md-12 m-b-30">
                            ...
                            <div class="d-block d-lg-flex flex-nowrap align-items-center">
                                <div class="page-title mr-4 pr-4 border-right">
                                    <h1 class="text-primary"><a href="{{route('admin.dashboard.portfolio.index')}}">Portfolio</a> / <span class="text-secondary"> create</span></h1>
                                </div>
                                ...
                                <div class="container">
                                    <form action="{{route('admin.dashboard.portfolio.store')}}" style="max-width: 800px" method="POST">
                                        ...
                                        <div class="form-group row align-items-center center mb-3">
                                            ...
                                            <div class="col-md-8">
                                                <input type="text" name="section" value="{{old('section')}}" placeholder="Enter a name for the section " id="section" class="form-control @error('section') is-invalid @enderror" />
                                            </div>
                                            @if($errors->has('section'))
                                                <strong class="text-danger mb-3">{{ $errors->first('section') }}</strong>
                                            @endif
                                        </div>
                                        <input type="submit" value="add section" class="btn btn-primary btn-block text-capitalize">
                                    </form>
                                </div>
                            </div>
                        </div>
