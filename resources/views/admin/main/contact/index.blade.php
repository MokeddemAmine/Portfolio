                        ...
                        <div class="col-md-12 m-b-30">
                            ...
                            <div class="d-block d-lg-flex flex-nowrap align-items-center">
                                <div class="page-title mr-4 pr-4 border-right">
                                    <h1>Main / <span class="text-secondary">Contact</span></h1>
                                </div>
                            ...
                            <div class="page-content my-4">
                                <div class="container">
                                    ...
                                    @endif
                                    <a href="{{route('admin.dashboard.main.contact.edit')}}" class="btn btn-info btn-sm my-3 text-capitalize">edit info</a>
                                </div>
                            </div>
                        </div>
                    </div>
