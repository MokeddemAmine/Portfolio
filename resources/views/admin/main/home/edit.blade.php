                        ...
                        <div class="col-md-12 m-b-30">
                            ...
                            <div class="d-block d-lg-flex flex-nowrap align-items-center">
                                <div class="page-title mr-4 pr-4 border-right">
                                    <h1 class="text-primary"><a href="{{route('admin.dashboard.main.index')}}">Main</a> / <a href="{{route('admin.dashboard.main.home.index')}}">Home</a> / <span class="text-secondary">edit</span> </h1>
                                </div>
